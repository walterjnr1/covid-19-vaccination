...
<head>
    ...
    <title>User Record|Dashboard</title>
                ...
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    ...
                    <tr class="gradeX">
                        ...
                        <td class="center"><?php echo $row['vaccinationDate'];  ?></td>
						 <td class="center"><?php echo $row['timeslot'];  ?></td>
...
<a href="edit_status.php?id=<?php echo $row['ID'];?>&vid=<?php echo $row['vaccinationID'];?>"><button type="button" class="btn btn-primary">Update Status</button></a>
